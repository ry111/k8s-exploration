...
#
# Example:
#   ./grant-github-actions-access.sh arn:aws:iam::123456789012:user/github-actions day-cluster-eksCluster-f3c27b8
#
...
if [ $# -ne 2 ]; then
    ...
    echo ""
    echo "Example:"
    echo "  $0 arn:aws:iam::123456789012:user/github-actions day-cluster-eksCluster-f3c27b8"
    echo ""
