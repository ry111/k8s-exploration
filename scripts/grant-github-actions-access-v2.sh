#!/bin/bash
#
# Grant GitHub Actions IAM Principal Access to EKS Cluster (Using Access Entries)
#
# This script uses the newer EKS Access Entry API instead of aws-auth ConfigMap.
# Access Entries are the recommended approach for EKS 1.23+
#
# Usage:
...
echo "==========================================================="
echo "Grant GitHub Actions Access to EKS Cluster (Access Entries)"
echo "==========================================================="
echo ""
